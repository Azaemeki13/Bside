...
import type { PlaylistSongItem } from '../../models/playlist.models';
...
/** Turns the selected playlist into playable, shareable, and editable rows. */
@Component({
...
export class SongList implements OnInit {
  ...
  shareSong(event: Event, song: PlaylistSongItem, friend: FriendListItem): void {
    ...
    const isSentToSocket = this.chatSocket.sendSongMessage(friend.user_id, song.song_id);
