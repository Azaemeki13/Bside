...
export const routes: Routes = [
    ...
    { path: 'privacy-policy', component: PrivacyPolicy },
    {
        ...
        children: [
            ...
            { path: 'library/liked', component: BsideLibrary, canActivate: [authOrTryMeGuard], data: { libraryView: 'liked' } },
            { path: 'library/daily-mix', component: BsideLibrary, canActivate: [authOrTryMeGuard], data: { libraryView: 'daily-mix' } },
            { path: 'library/playlist/:playlistId', component: BsideLibrary, canActivate: [authOrTryMeGuard], data: { libraryView: 'playlist' } },
            ...
            { path: 'social/chat/:userId', component: BsideSocial, canActivate: [authOrTryMeGuard] },
            ...
            { path: 'settings/profile', component: BsideSettings, canActivate: [authOrTryMeGuard], data: { settingsView: 'profile' } },
            { path: 'settings/activity', component: BsideSettings, canActivate: [authOrTryMeGuard], data: { settingsView: 'activity' } },
            { path: 'settings/artist', component: BsideSettings, canActivate: [authOrTryMeGuard], data: { settingsView: 'artist' } },
        ],
    },
